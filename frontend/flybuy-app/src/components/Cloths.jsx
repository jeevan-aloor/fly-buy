import { Box, Heading, Grid, GridItem, Image, Text, Flex, Button, Checkbox } from '@chakra-ui/react'
...
function Cloths() {
  ...
  return (
    <Box>
      ...
      <Flex w="100%" gap="10px">
        <Box w="20%" border="1px solid red" mt="80px"  h="200px">
          <Checkbox onClick={handleclick}/>
        </Box>
      <Grid templateColumns='repeat(5, 1fr)' gap={2} h="500px" border="1px solid red"  w="80%" m="auto"mt="80px" alignItems="end" fontFamily="Times New Roman,serif" >
        {
          clothdata.length > 0 && clothdata.map((ele) => (
            <GridItem h="100%" w="100%" border="1px solid red" background="#CFD7DE" key={ele._id} fontFamily="Times New Roman,serif">
              ...
              <Text textAlign="left" ml="20px">{ele.clothcategory}</Text>
              <Box display="flex">
